...
public class MienBacDAO {

    public static final String TABLE_NAME = "MienBac";
    public DatabaseHelper dbHelper;
    public SQLiteDatabase db;
    public static final String SQL_MIENBAC =" CREATE TABLE IF NOT EXISTS MienBac(" +
            "Id INTEGER PRIMARY KEY AUTOINCREMENT,Ten VARCHAR(150), Mota VARCHAR(250),HinhAnh BLOB)";

    public MienBacDAO(Context context) {
