...
public class MienBacAdapter extends BaseAdapter {
    List<TraiCay> arrTraiCay;
    Context context;
    LayoutInflater inflater;
    MienBacDAO mienBacDAO;

    public MienBacAdapter(List<TraiCay> arrTraiCay, Context context) {
        this.arrTraiCay = arrTraiCay;
        this.context = context;
        this.inflater = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mienBacDAO =  new  MienBacDAO(context);
    }
        ...
        if(convertView==null){
            ...
            holder.imvDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mienBacDAO.deleteTraiCay(arrTraiCay.get(position).getTen());
